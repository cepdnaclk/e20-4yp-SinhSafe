...
def run_cv_training(df):
    ...
    print(f"🚀 Starting 5-Fold CV on GPU 1 (Mixed Precision & Logging-Only)...")
    ...
    # --- FINAL SUPERVISOR REPORT (V5 STYLE) ---
...
if __name__ == "__main__":
    print("\n" + "="*60 + "\n⚙️ CONFIG: MIXED PRECISION & GRADIENT ACCUMULATION (NO SHARDS)\n" + "="*60)
