...
OUTPUT_DIR = "./results/sinhsafe_v2"
FINAL_MODEL_DIR = "./models/sinhsafe_v2_split"
...
trainer = SFTTrainer(
    ...
    eval_dataset=val_dataset, # <--- Added the Validation Set here
    args=SFTConfig(
        ...
        warmup_steps=100,
        num_train_epochs=1,       # CHANGED: Early stopping
        learning_rate=5e-5,       # CHANGED: Gentler learning rate
        weight_decay=0.05,        # NEW: Penalizes memorization
        bf16=True, 
        logging_steps=10,
        eval_strategy="steps",    # CHANGED: Check validation every 50 steps instead of waiting for the end of the epoch
        eval_steps=50,
        save_strategy="epoch",
